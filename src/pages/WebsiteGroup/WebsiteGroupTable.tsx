...
// PROJECT IMPORT
import { websiteGroup } from "features/websiteGroup/websiteGroupSlice";
    ...
    <Box sx={{ position: "relative", pb: 2 }}>
      <TableContainer sx={{ overflow: "auto" }}>
        <Table>
          ...
          <TableBody>
            {websiteGroups?.map((item, index) => renderTableBody(item, index))}
          </TableBody>
        </Table>
...
export default WebsiteGroupTable;
